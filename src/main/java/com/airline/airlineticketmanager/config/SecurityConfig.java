        ...
        http.authorizeRequests()
            ...
            .permitAll()
                .antMatchers(AUTH + "/register/**")
                    .hasAuthority(RoleValue.ROLE_ADMIN.getName())
                .antMatchers(AUTH + "/**")
                    .permitAll()
                .antMatchers(HttpMethod.GET, API_PATH + "/**")
                    .hasAnyAuthority(RoleValue.ROLE_ADMIN.getName(), RoleValue.ROLE_API_READ.getName(), RoleValue.ROLE_API_WRITE.getName())
                .antMatchers(HttpMethod.POST, API_PATH + "/**")
                    .hasAnyAuthority(RoleValue.ROLE_ADMIN.getName(), RoleValue.ROLE_API_WRITE.getName())
